...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-caper-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-caper-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-caper-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-caper-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-caper-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-caper-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-caper` can be installed with:

```
conda install r-caper
```

It is possible to list all of the versions of `r-caper` available on your platform with:
